...
{   
    ...
    powershell Get-ChildItem -Path "C:\" -Recurse -exclude "C:\Windows" -File -Filter '*.exe'  | Where {$FilesDownloaded -contains $_.Name} | Out-file -Append "$env:userprofile\Desktop\output.txt" 
