...
function Get-Tweaks {
    ...
    Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/Relativity-Environment/Relativity_Scripts/master/TWEAKS/Windows Terminal.lnk" -Outfile "$env:LOCALAPPDATA\RELATIVITY\TWEAKS\Windows Terminal"  
