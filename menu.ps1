...
function Install-Module{
  ...
  $null = New-Item -ItemType Directory -Path "$env:LOCALAPPDATA\RELATIVITY" 
  Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/Relativity-Environment/Relativity_Scripts/master/MODULE/module.psm1" -Outfile "$env:LOCALAPPDATA\RELATIVITY\module.psm1" 
