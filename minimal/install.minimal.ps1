...
Get-DownloadManual -UtilDownloadPath "$env:TEMP\vuls" -UtilBinPath "$UtilBinPath"
Install-Soft -UtilDownloadPath "$env:TEMP\vuls" -UtilBinPath "$UtilBinPath\Analisis de Vulnerabilidades"
Add-EnvPath
